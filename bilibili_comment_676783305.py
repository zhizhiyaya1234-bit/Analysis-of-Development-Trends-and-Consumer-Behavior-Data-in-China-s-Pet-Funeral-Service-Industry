...
class BilibiliCommentCrawler:
    ...
    def get_video_info(self, aid: int = 676783305) -> dict:
        """获取视频信息"""
        try:
    ...
    def get_comments_page(self, oid: int = 676783305, page: int = 1) -> dict:
        """获取单页评论数据"""
        try:
    ...
    def get_sub_comments(self, root_id: int, oid: int = 676783305, page: int = 1) -> dict:
        """获取子评论（楼中楼）"""
        try:
    ...
    def parse_comment(self, comment_data: dict, video_id: int = 676783305) -> dict:
    ...
    def crawl_comments(self, 
        ...
        print("=" * 60)
        print(f"开始爬取B站视频 676783305 的评论")
        print("=" * 60)
    ...
    def save_to_excel(self, comments: list, filename: str = None):
        ...
        with pd.ExcelWriter(filename, engine='openpyxl') as writer:
            df.to_excel(writer, sheet_name='video_676783305', index=False)
